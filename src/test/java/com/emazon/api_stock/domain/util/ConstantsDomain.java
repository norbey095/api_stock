...
public class ConstantsDomain {
    ...
    public static final String  MSN_NAME_CARACTER = "El campo 'nombre' no puede exceder de 50 caracteres.";
    public static final String MSN_NAME_NULL = "El campo 'nombre' no puede estar vacío.";
