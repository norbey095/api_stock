...
public class ConstantsInfraestructure {
    ...
    public static final String BRAND_EXISTS = "Ya existe una marca con ese nombre";
    ...
    public static final String ARTICLE_EXISTS="Ya existe un artículo con ese nombre";
